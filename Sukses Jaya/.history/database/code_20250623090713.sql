...
('admin', 'admin1', 'Admin', 1),
('admin2', 'admin2', 'Admin', 2),
('admin3', 'admin3', 'Admin', 3),
('admin4', 'admin4', 'Admin', 4),
('admin5', 'admin5', 'Admin', 5),
('pegawai1', 'pegawai1', 'Pegawai', 6),
('pegawai2', 'pegawai2', 'Pegawai', 7),
('pegawai3', 'pegawai3', 'Pegawai', 8),
('pegawai4', 'pegawai4', 'Pegawai', 9),
('pegawai5', 'pegawai5', 'Pegawai', 10);
