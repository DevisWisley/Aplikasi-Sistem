...
CREATE TABLE pegawai (
    ...
    FOREIGN KEY (jabatan_id) REFERENCES jabatan(jabatan_id) ON UPDATE CASCADE ON DELETE RESTRICT,
    FOREIGN KEY (cabang_id) REFERENCES cabang(cabang_id) ON UPDATE CASCADE ON DELETE RESTRICT
);
