        ...
        <tbody>
            <?php $no = 1; foreach ($data as $row): ?>
                <tr>
                    ...
                    <td><?= $row['level'] ?></td>
                    <td>
                        <button class="btn btn-warning btn-sm" onclick='editAdmin(<?= json_encode($row) ?>)'><i class="fas fa-edit"></i></button>
                        <button class="btn btn-danger btn-sm" onclick='hapusAdmin(<?= $row["admin_id"] ?>)'><i class="fas fa-trash"></i></button>
