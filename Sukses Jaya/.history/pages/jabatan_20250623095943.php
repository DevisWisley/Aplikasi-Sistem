...
<div class="p-4 w-100">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
            <button class="btn btn-warning btn-sm" onclick='editJabatan(<?= json_encode($jabatan) ?>)'><i class="fas fa-edit"></i></button>
            <button class="btn btn-danger btn-sm" onclick='hapusJabatan(<?= $jabatan["jabatan_id"] ?>)'><i class="fas fa-trash"></i></button>
            <button class="btn btn-info btn-sm" onclick='showDetail(<?= json_encode($jabatan) ?>)'><i class="fas fa-eye"></i></button>
        </td>
      </tr>
      <?php endforeach; ?>
    </tbody>
