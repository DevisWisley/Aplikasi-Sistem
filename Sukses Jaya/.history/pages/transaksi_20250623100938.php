...
<div class="p-4 w-100">
    <div class="d-flex justify-content-between mb-4">
        <h3 data-aos="fade-right">Transaksi Data Pegawai</h3>
    ...
    <table class="table table-bordered table-striped" id="transaksiTable">
        ...
        <tbody>
        <?php $no = 1; foreach ($transaksis as $row): ?>
            <tr>
                <td><?= $no++; ?></td>
                <td><?= $row['nama']; ?></td>
                ...
                <td>
                    ...
                    <button class="btn btn-danger btn-sm" onclick='hapusTransaksi(<?= $row["transaksi_id"] ?>)'><i class="fas fa-trash"></i></button>
                </td>
            </tr>
        <?php endforeach; ?>
        </tbody>
